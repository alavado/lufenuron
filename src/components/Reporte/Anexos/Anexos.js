...
const Anexos = props => {
  ...
  return (
    <div id="anexos">
      ...
      <div id="referencias">
        <h2>Referencias</h2>
        <p>Este informe fue generado con el Simulador VisiOn – MSD Salud Animal. Esta herramienta es un Simulador de Estrategias Antiparasitarias que permite al usuario ingresar los datos característicos de un centro de cultivo de peces para comparar el resultado de dos estrategias de tratamientos contra Cáligus.</p>
        ...
        <p><span className="fuente">El Simulador VisiOn – MSD Salud Animal fue desarrollado por Ceres BCA para MSD Salud Animal en Chile.</span></p>
      </div>
    </div>
  );
};
